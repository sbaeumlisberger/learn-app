...
class _SettingsPageState extends State<SettingsPage> {
  final titleStyle = const TextStyle(fontSize: 24);
    ...
    return Scaffold(
        ...
        body: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(msg.themeTitle, style: titleStyle),
              DropdownButton(
                  items: [
              ...
              Text(msg.colorTitle, style: titleStyle),
              BlockPicker(
                  availableColors: [
                    Colors.blue,
                    Colors.indigo,
                    ...
                    Colors.amber,
                    Colors.lime,
                    Provider.of<ThemeNotifier>(context).accentColor,
              ...
              const SizedBox(height: 32),
              Text(msg.creditsTitle, style: titleStyle),
              const SizedBox(height: 4),
              InkWell(
              ...
              const SizedBox(height: 32),
              Text(msg.sourceCodeTitle, style: titleStyle),
              const SizedBox(height: 4),
              InkWell(
